...
export default function PlaybookIndexPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Playbooks', item: 'https://aitraining.id/playbook' },
    ],
  };
          ...
          <section className="relative pt-32 pb-16 px-6 sm:px-8">
            <div className="max-w-[1400px] mx-auto">
              <div className="max-w-3xl">
                <p className="text-white/50 text-sm mb-4 tracking-wide">[ Playbooks & Panduan ]</p>
                ...
                <p className="text-white/70 text-lg sm:text-xl max-w-2xl leading-relaxed">
                  Panduan praktis, template prompt, dan companion resource dari workshop & webinar{' '}
                  <a
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {playbooks.map((pb) => (
                  ...
                  >
                    ...
                    <p className="text-white/65 leading-relaxed mb-5">{pb.description}</p>
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-xs text-white/35 font-mono">Companion: {pb.companion}</p>
                ...
                <div className="border border-dashed border-white/10 rounded-2xl p-8 flex flex-col items-center justify-center text-center gap-3 min-h-[280px]">
                  <p className="text-white/25 text-sm font-mono">[ Coming soon ]</p>
                  <p className="text-white/40 font-medium">More playbooks on the way</p>
                  <p className="text-white/30 text-sm max-w-xs">
                    Playbook baru ditambahkan setiap kali ada workshop atau webinar baru.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-[1400px] mx-auto">
              <div className="max-w-xl">
                ...
                <p className="text-white/65 mb-8 leading-relaxed">
                  Playbook ini adalah versi ringkas dari training langsung. Untuk pengalaman belajar
                  yang lebih mendalam, lihat program corporate AI training atau jadwalkan sesi konsultasi.
                </p>
