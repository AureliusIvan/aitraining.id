...
export const metadata: Metadata = {
  ...
  description:
    "Corporate AI training on-site di Jakarta, Surabaya, Bandung, Tangerang, Yogyakarta, Bali, Medan, Semarang, Makassar, Palembang, Balikpapan, Malang, Batam, dan kota lainnya di Indonesia. Delivered by Aurelius Ivan Wijaya dari aurelivan.com.",
  alternates: {
