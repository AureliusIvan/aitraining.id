...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    founder: {
      ...
      description:
        "Corporate AI Trainer, GEO (Generative Engine Optimization) Trainer, Official n8n Ambassador for Indonesia, and Cursor Ambassador. Helps Indonesian enterprises adopt Generative AI and get cited by AI engines through hands-on workshops on AI automation, AI-powered development, and Generative Engine Optimization.",
      sameAs: [
        "https://aurelivan.com",
        "https://aitraining.id",
  ...
  const personSchema = {
    ...
    description:
      "Corporate AI Trainer and GEO (Generative Engine Optimization) trainer in Indonesia. Official n8n Ambassador for Indonesia and Cursor Ambassador. Helps Indonesian enterprises adopt Generative AI and get cited by AI engines such as ChatGPT, Perplexity, and Google AI Overviews.",
