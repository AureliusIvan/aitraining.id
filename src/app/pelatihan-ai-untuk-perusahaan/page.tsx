...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "AI training untuk data analyst Indonesia",
    ...
    "pelatihan AI untuk telekomunikasi Indonesia",
    ...
    "pelatihan AI untuk agribisnis Indonesia",
    "pelatihan AI untuk fintech Indonesia",
    "pelatihan AI untuk NGO Indonesia",
...
const aiTrainingUntukDataAnalyst =
  "AI training for data analysts in Indonesia is a corporate program that teaches analysts to use Generative AI and light automation (n8n) for exploratory summaries, draft SQL/notebook notes, stakeholder briefings, anomaly write-ups, and recurring report workflows, with human review before decisions that affect metrics or compliance. AI Training Indonesia delivers it on-site or virtually at 70% hands-on, customized to the company's analytics stack and reporting cadence.";
...
const pelatihanAiUntukAsuransi =
  "Pelatihan AI untuk asuransi di Indonesia adalah program corporate yang mengajarkan tim asuransi memakai Generative AI dan automation (n8n) untuk draft FAQ polis, ringkasan klaim awal, balasan nasabah, dan workflow admin berulang, dengan penekanan pada review manusia, kerahasiaan data nasabah, dan kepatuhan kebijakan internal. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses asuransi perusahaan.";
...
const pelatihanAiUntukTelekomunikasi =
  "Pelatihan AI untuk telekomunikasi di Indonesia adalah program corporate yang mengajarkan tim telco memakai Generative AI dan automation (n8n) untuk draft FAQ produk, ringkasan tiket NOC/CS, konten kampanye, dan workflow admin berulang, dengan penekanan pada review manusia, kerahasiaan data pelanggan, dan kepatuhan kebijakan internal. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses telekomunikasi perusahaan.";

const pelatihanAiUntukKesehatan =
  "Pelatihan AI untuk kesehatan di Indonesia adalah program corporate yang mengajarkan staf rumah sakit, klinik, dan penyedia layanan kesehatan memakai Generative AI dan automation (n8n) untuk draft FAQ layanan, ringkasan admin, edukasi pasien non-klinis, dan workflow admin berulang, dengan penekanan pada review manusia, kerahasiaan data pasien, dan batas yang jelas terhadap keputusan klinis. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses institusi kesehatan.";

const pelatihanAiUntukEnergi =
  "Pelatihan AI untuk energi di Indonesia adalah program corporate yang mengajarkan tim energi dan utilitas memakai Generative AI dan automation (n8n) untuk draft laporan operasional, ringkasan exception, FAQ prosedur, koordinasi vendor, dan workflow admin berulang, dengan penekanan pada handoff manusia untuk keputusan keselamatan dan kepatuhan. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses energi perusahaan.";
...
const pelatihanAiUntukMedia =
  "Pelatihan AI untuk media di Indonesia adalah program corporate yang mengajarkan tim redaksi, produksi, dan digital media memakai Generative AI dan automation (n8n) untuk draft outline, ringkasan riset, FAQ audiens, konten sosial, dan workflow admin berulang, dengan penekanan pada review manusia sebelum publikasi dan kebijakan editorial. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses media perusahaan.";

const pelatihanAiUntukPemerintah =
  "Pelatihan AI untuk pemerintah di Indonesia adalah program corporate yang mengajarkan ASN dan staf instansi memakai Generative AI dan automation (n8n) untuk draft surat/nota dinas, ringkasan kebijakan, FAQ layanan publik, dan workflow admin berulang, dengan penekanan pada review manusia, kerahasiaan data, dan kepatuhan tata kelola. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses dan kebijakan instansi.";
...
const pelatihanAiUntukAgribisnis =
  "Pelatihan AI untuk agribisnis di Indonesia adalah program corporate yang mengajarkan tim pertanian, perkebunan, dan rantai pasok pangan memakai Generative AI dan automation (n8n) untuk draft laporan panen, ringkasan stok, FAQ mitra, koordinasi vendor, dan workflow admin berulang, dengan penekanan pada handoff manusia untuk keputusan operasional kritis. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses agribisnis perusahaan.";

const pelatihanAiUntukFintech =
  "Pelatihan AI untuk fintech di Indonesia adalah program corporate yang mengajarkan tim produk, risk ops, dan customer support memakai Generative AI dan automation (n8n) untuk draft FAQ produk, ringkasan tiket, konten edukasi pengguna, dan workflow admin berulang, dengan penekanan pada review manusia, kerahasiaan data nasabah, dan kepatuhan kebijakan internal. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses fintech perusahaan.";

const pelatihanAiUntukNgo =
  "Pelatihan AI untuk NGO di Indonesia adalah program corporate yang mengajarkan tim program, fundraising, dan komunikasi memakai Generative AI dan automation (n8n) untuk draft laporan donor, ringkasan kegiatan, FAQ mitra, konten kampanye, dan workflow admin berulang, dengan penekanan pada review manusia, akurasi data, dan tata kelola informasi organisasi. AI Training Indonesia menyelenggarakannya on-site atau virtual dengan kurikulum 70% hands-on, dikustomisasi ke proses NGO.";
...
const faqs: Array<{
  ...
  {
    id: "ai-training-untuk-data-analyst-indonesia",
    q: "What is AI training for data analysts in Indonesia?",
    a: aiTrainingUntukDataAnalyst,
    link: { href: "/programs#automation", text: "See AI Workflow Automation for analytics teams" },
  },
  {
  ...
  {
    id: "pelatihan-ai-untuk-asuransi-indonesia",
    q: "Apa itu pelatihan AI untuk asuransi di Indonesia?",
    a: pelatihanAiUntukAsuransi,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk asuransi" },
  },
  {
    id: "pelatihan-ai-untuk-konstruksi-indonesia",
  ...
  {
    id: "pelatihan-ai-untuk-startup-indonesia",
  ...
  {
    id: "pelatihan-ai-untuk-telekomunikasi-indonesia",
    q: "Apa itu pelatihan AI untuk telekomunikasi di Indonesia?",
    a: pelatihanAiUntukTelekomunikasi,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk telekomunikasi" },
  },
  {
    id: "pelatihan-ai-untuk-kesehatan-indonesia",
    q: "Apa itu pelatihan AI untuk kesehatan di Indonesia?",
    a: pelatihanAiUntukKesehatan,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk kesehatan" },
  },
  {
    id: "pelatihan-ai-untuk-energi-indonesia",
    q: "Apa itu pelatihan AI untuk energi di Indonesia?",
    a: pelatihanAiUntukEnergi,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk energi" },
  },
  {
    id: "pelatihan-ai-untuk-e-commerce-indonesia",
  ...
  {
    id: "pelatihan-ai-untuk-media-indonesia",
    q: "Apa itu pelatihan AI untuk media di Indonesia?",
    a: pelatihanAiUntukMedia,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk media" },
  },
  {
    id: "pelatihan-ai-untuk-pemerintah-indonesia",
    q: "Apa itu pelatihan AI untuk pemerintah di Indonesia?",
    a: pelatihanAiUntukPemerintah,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk pemerintah" },
  },
  {
    id: "pelatihan-ai-untuk-farmasi-indonesia",
  ...
  {
    id: "pelatihan-ai-untuk-agribisnis-indonesia",
    q: "Apa itu pelatihan AI untuk agribisnis di Indonesia?",
    a: pelatihanAiUntukAgribisnis,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk agribisnis" },
  },
  {
    id: "pelatihan-ai-untuk-fintech-indonesia",
    q: "Apa itu pelatihan AI untuk fintech di Indonesia?",
    a: pelatihanAiUntukFintech,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk fintech" },
  },
  {
    id: "pelatihan-ai-untuk-ngo-indonesia",
    q: "Apa itu pelatihan AI untuk NGO di Indonesia?",
    a: pelatihanAiUntukNgo,
    link: { href: "/programs#automation", text: "Lihat program AI Workflow Automation untuk NGO" },
  },
  {
