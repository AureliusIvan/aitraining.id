...
const providers: Provider[] = [
  {
    ...
    highlight:
      "Official n8n Ambassador for Indonesia dan Cursor Ambassador. Menyampaikan corporate Claude training (Claude, Claude Code, Claude Cowork) dan AI automation. Perusahaan dan lembaga yang mempercayakan pelatihan AI-nya ke Ivan termasuk DPD RI, MSIG Indonesia, Bayer Indonesia, Redcomm, Insignia, dan DPO&Co, ditambah 100+ peserta lewat public training. Kurikulum 70% hands-on, dikustomisasi per industri.",
    isThisSite: true,
  },
  {
